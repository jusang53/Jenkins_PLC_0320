...
% 
% 
% code = T1(n_excel,45); code = code{1,1}; code = code{1,1}; code = str2num(code); Digit3 = fix(code/100); Digit2 = rem(code,100);
% str = sprintf('::Modbus_input%d',Digit3);
% Modbus_Physical = findNodeByName(uaClient.Namespace,str);
% Physical_val = Modbus_Physical.Children(Digit2+1);
% 
% code = T1(n_excel,37); code = code{1,1}; code = code{1,1}; code = str2num(code); Digit3 = fix(code/100); Digit2 = rem(code,100);
% str = sprintf('::Modbus_hold%d_2',Digit3);
% Modbus_ForceEnable = findNodeByName(uaClient.Namespace,str);
% Forcing_Val = Modbus_ForceEnable.Children(Digit2+1);
% 
% code = T1(n_excel,36); code = code{1,1}; code = code{1,1}; code = str2num(code); Digit3 = fix(code/100); Digit2 = rem(code,100);
% str = sprintf('::Modbus_hold%d_2',Digit3);
% Modbus_ForceValue = findNodeByName(uaClient.Namespace,str);
% Forcing_En = Modbus_ForceValue.Children(Digit2+1);
Global_Node();
Alarm = T1(n_excel,26);
Alarm = table2array(Alarm);
Alarm = str2num(Alarm{1,1});
